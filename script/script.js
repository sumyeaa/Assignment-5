...
const displaydata=(allbtns)=>{
    ...
    //priority button part
      ...
      //html added
        ...
        all.innerHTML=`
           <div class="bg-slate-100 h-full flex flex-col max-w-[350px] md:max-w-[300px] lg:max-w-[256px] p-5 rounded-xl space-y-4 mx-auto mt-3 ${cardborder}">
            ...
            <p class="text-gray-400 text-xs mb-3">#1 by john_doe</p>
